...
class MaskRCNN():
    ...
    def detect(self, images, verbose=0):
        ...
        if verbose:
            ...
            for image in images:
                logging.info("image %s", image.shape)
        ...
        if verbose:
            logging.info("molded_images %s", molded_images.shape)
            logging.info("image_metas %s", image_metas.shape)
    ...
    def detect_molded(self, molded_images, image_metas, verbose=0):
        ...
        if verbose:
            logging.info("Processing {} images".format(len(molded_images)))
